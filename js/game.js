...
var enemies = {
    straight: { x: 0, y: -50, sprite: 'enemy_ship', health: 10, E: 100, firePercentage: 0.001 },
    ltr: { x: 0, y: -100, sprite: 'enemy_purple', health: 10, B: 400, C: 6, E: 200, missiles: 2 },
    circle: { x: 400, y: -50, sprite: 'enemy_circle', health: 10, A: 0, B: -200, C: 1, E: 20, F: 200, G: 1, H: Math.PI/2 },
    wiggle: { x: 100, y: -50, sprite: 'enemy_bee', health: 20, B: 100, C: 4, E: 100, firePercentage: 0.001, missiles: 2 },
    step: { x: 0, y: -50, sprite: 'enemy_circle', health: 10, B: 250, C: 1.5, E: 60 }
...
var winGame = function (){
  Game.setBoard(3, new TitleScreen("You win", "Press fire to replay", playGame))
};

var loseGame = function (){
    Game.setBoard(3, new TitleScreen("You are dead", "Press fire to replay", playGame))
};
